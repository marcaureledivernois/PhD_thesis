...
Contributions of this paper are both in network identification literature as well in finance.
...
Side information can also help to infer the DIG of a dynamical system without directly estimating the DIs but instead it provides an alternative approach to identify the DIG. 
...
\paragraph{Koopman-based lifting technique}
...
%further results are robust to changes of parameters.
\begin{figure}
    \centering
    \includegraphics[scale=.2]{fig_matrix.pdf}
...
\begin{figure*}
        ...
        \end{subfigure}
        \caption{Precision and recall curves in the linear framework for the \textit{True parents}, \textit{Most correlated}, \textit{Ideal portfolio}, and the \textit{RNN}, respectively.} 
        \label{perflin}
    \end{figure*}
...
%Conditioning on the true parents obviously performs the best as all the information is included in the Directed Information. 
%However, it is also the heaviest in terms of computational time. 
...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{precrecall_15assets.jpg}
...
\begin{figure*}
        ...
        \end{subfigure}
        \caption{Empirical DIG for the periods 1990-1994 (top) and 1995-1999 (bottom). Interactive graphs can be found at https://marcaureledivernois.github.io/firm-network/} 
        \label{empdig1}
    \end{figure*}
...
\begin{figure*}[]
        ...
        \end{subfigure}
        \caption{Empirical DIG for the periods 2000-2004 (top) and 2005-2009 (bottom). Interactive graphs can be found at https://marcaureledivernois.github.io/firm-network/} 
        \label{empdig2}
    \end{figure*}
...
\begin{figure*}
        ...
        \end{subfigure}
        \caption{Empirical DIG for the periods 2010-2014 (top) and 2015-2019 (bottom). Interactive graphs can be found at https://marcaureledivernois.github.io/firm-network/} 
        \label{empdig3}
    \end{figure*}    
