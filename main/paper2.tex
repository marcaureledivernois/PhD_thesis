...
"y":"z"
   ...
   \mycaption{DIG of the system in \eqref{model1}}{}
...
\mycaption{Koopman lifting technique compared to classical non-linear identification}{}
\label{fig:koopman}
\end{figure}
...
\begin{figure}
    ...
    \mycaption{Structure of matrix $\textbf{A}$ in \eqref{eq:ex_lin} that is build using \eqref{eq:rules}.}{}
    \label{fig:matrix}
\end{figure}
...
\mycaption{Precision-Recall curves for the quadratic model.}{}
