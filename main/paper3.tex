...
\begin{figure*}[]
        ...
        \end{subfigure}
        \caption{Time series of daily polarity (red - left axis) and daily stock returns (blue - right axis) since 1st of January 2019 for the top 6 most discussed tickers. Pearson correlation between the two time series is shown in the title.} 
        \label{fig:ts}
    \end{figure*}
...
\begin{figure*}[]
        ...
        \end{subfigure}
        \caption{Long and Short portfolio for x=2.58.} 
        \label{fig:pf}
    \end{figure*}
