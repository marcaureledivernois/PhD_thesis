...
\subsection{Variance restriction method to estimate DtD}
...
\subsection{Proof of Lemma \ref{lemma:small}}
...
\subsection{Proof of Lemma \ref{lemma:lin}}
...
\subsection{Proof of Lemma \ref{lemma:nonlinear}}
...
\begin{comment}
\section*{Appendix D : Ideal portfolio}
...
\newpage
\section{Tutorial for StockTwits messages extraction}
...
\begin{figure}[h]
    ...
    \caption{Cumulative log returns of both portfolios (x=1.96) and the S\&P500.}
    \label{fig:cumpf1}
\end{figure}
...
\begin{figure*}[h]
       ...
       %\vskip\baselineskip
        ...
        \end{subfigure}
        \caption{Long and Short portfolio for x = 1.96.} 
        \label{fig:pf1}
    \end{figure*}
...
\begin{figure}[h]
    ...
    \caption{Cumulative log returns of both portfolios (x=2.81) and the S\&P500.}
    \label{fig:cumpf3}
\end{figure}
...
\begin{figure*}[h]
        ...
        \begin{subfigure}[b]{0.42\textwidth}   
            ...
            \caption*{Daily returns}  
        \end{subfigure}
        \caption{Long and Short portfolio for x=2.81.} 
        \label{fig:pf3}
    \end{figure*}
